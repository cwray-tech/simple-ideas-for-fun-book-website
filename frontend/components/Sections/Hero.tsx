  ...
  return (
    <>
      <div className="relative w-full h-full pb-10">
        ...
        <div className="relative px-4 xl:px-0 container mx-auto grid md:grid-cols-7 items-center gap-x-16 gap-y-6">
          <div className="text-color w-full md:col-span-3 pt-16 lg:pt-32 xl:pt-12">
          ...
          <img
            className="w-full rounded shadow-sm md:col-span-4 mt-8 md:mt-0 object-fill md:-ml-4 lg:-ml-4 xl:ml-0"
            src="/book-picture-simple-ideas-for-fun.jpg"
            alt="sample page"
          />
          <button className="md:hidden hover:opacity-90 text-base w-full f-f-r py-4  bg-indigo-700 text-white font-bold focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 rounded-lg">
            Start building now
          </button>
          <button className="md:hidden hover:opacity-90 text-base w-full f-f-r py-4  bg-indigo-200 text-indigo-600 font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 rounded-lg">
            Try it out
          </button>
        </div>
      </div>
